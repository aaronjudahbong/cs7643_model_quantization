...
def run_qat(idx, config, results_dir):
    ...
    # print("Calculate mIOU BEFORE calibration")
    # run_miou(prepared_model, device, val_dataloader)
    ...
    # print("Calculate mIOU AFTER calibration")
    # run_miou(prepared_model, device, val_dataloader)
    ...
    for epoch in range(epochs):
        ...
        print(f"Calculate mIOU DURING training epoch {epoch}")
        # Concatenate all predictions and targets
        all_predictions = torch.cat(all_predictions, dim=0)
        all_targets = torch.cat(all_targets, dim=0)
        # Calculate mIoU
    ...
    # print("eval miou w aarons function - prepared")
    # evaluation = evaluate_model(
    #     model = prepared_model.to("cpu").eval(),
    ...
    # Metrics
    # print("eval miou w aarons function - quant")
    # evaluation = evaluate_model(
    #     model = quantized_model.to("cpu").eval(),
    #     val_image_folder = val_img_path,
    #     val_label_folder = val_label_path,
    #     device = "cpu",
    #     batch_size = 1,
